...
exportgraphics(F3a,[path 'Figure_3a_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3b,[path 'Figure_3b_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3c,[path 'Figure_3c_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3d,[path 'Figure_3d_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3e,[path 'Figure_3e_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3f,[path 'Figure_3f_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3g,[path 'Figure_3g_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3h,[path 'Figure_3h_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3i,[path 'Figure_3i_kcs.pdf'],"ContentType","vector"),
exportgraphics(F3j,[path 'Figure_3j_kcs.pdf'],"ContentType","vector"),