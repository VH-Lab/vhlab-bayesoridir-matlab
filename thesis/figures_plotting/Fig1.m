...
%%
save my_fig1_new_kcs.mat I noisy_p noisy_w bayes_p bayes_w

%%
clear;close;clc;
load my_fig1_new_kcs.mat
...
exportgraphics(F1c,[path 'Figure_1c_kcs.pdf'],"ContentType","vector")
exportgraphics(F1d,[path 'Figure_1d_kcs.pdf'],"ContentType","vector")
exportgraphics(F1e,[path 'Figure_1e_kcs.pdf'],"ContentType","vector")
exportgraphics(F1f,[path 'Figure_1f_kcs.pdf'],"ContentType","vector")
exportgraphics(F1g,[path 'Figure_1g_kcs.pdf'],"ContentType","vector")
exportgraphics(F1h,[path 'Figure_1h_kcs.pdf'],"ContentType","vector")
exportgraphics(F1i,[path 'Figure_1i_kcs.pdf'],"ContentType","vector")
exportgraphics(F1j,[path 'Figure_1j_kcs.pdf'],"ContentType","vector")
