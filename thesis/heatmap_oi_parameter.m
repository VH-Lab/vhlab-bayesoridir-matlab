...
%%
plot.get_rpref(true_oi,filename,cell_type,1)
plot.get_alpha(true_oi,filename,cell_type,1)
plot.get_rsp(true_oi,filename,cell_type,1)
plot.get_sigma(true_oi,filename,cell_type,1)
plot.get_thetapref(true_oi,filename,cell_type,1)